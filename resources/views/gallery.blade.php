...
<div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNavigation">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav__item with-dropdown">
                            <a href="{{ route('gallery') }}"  class="dropdown-toggle nav__item-link active">Gallery</a>
                        </li><!-- /.nav-item -->
                        <li class="nav__item with-dropdown">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <span class="pagetitle__subheading">Memories</span>
    ...
    portfolio Gallery 
    ============================= -->
    <section id="portfolioGallery" class="portfolio portfolio-gallery">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row filtered-items-wrap">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mix {{ $menu->jenis == 'Makanan' ? 'filter-launch' : ($menu->jenis == 'Minuman' ? 'filter-drinks' : '') }}">
                    <div class="portfolio-item">
                        <div class="portfolio__img">
                        <img src="/images/menu/{{ ($menu->gambar) }}" alt="{{ $menu->nama }}" class="img-fluid" style="height: 200px; object-fit: cover;">
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio__hover">
                            <a href="/images/menu/{{ ($menu->gambar) }}" data-lightbox="lightbox" class="zoom__icon"></a>
                        </div>
                    </div><!-- /.portfolio-item -->
                </div><!-- /.col-lg-4 -->
                @endforeach
