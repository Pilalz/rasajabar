...
<body>
    <div class="wrapper">
        ...
        page title 
        =========================== -->
        <section id="heroBanner" class="hero-banner bg-overlay bg-overlay-2 py-0" style="height:150px;">
        ...
        <section id="page-title" class="page-title page-title-layout3 text-center" style="padding:100px;">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="/images/menu/{{ $menu->gambar }}" class="rounded float-left" alt="..." style="max-height: 100vh; object-fit: cover;">
                    </div>
